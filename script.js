...
class WebGLSlider extends Slider {
    ...
    onDragEnded(mousePosition) {
        ...
        if(Math.abs(this.translation - this.currentPosition) < 10) {
            easing = 'easeOutCubic';
    ...
    onTranslation() {
        ...
        var planeTranslation = {
            x: this.direction === 1 ? this.translation - this.previousTranslation.x : 0,
